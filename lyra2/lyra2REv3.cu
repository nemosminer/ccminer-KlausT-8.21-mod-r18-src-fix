...
extern void lyra2v3_cpu_hash_32(int thr_id, uint32_t threads, uint32_t startNonce, uint64_t *d_outputHash);

extern void lyra2v3_cpu_init(int thr_id, uint64_t* matrix);
...
void lyra2v3_hash(void *state, const void *input)
{
	...
	LYRA2(hashB, 32, hashA, 32, hashA, 32, 1, 4, 4, LYRA2_NOBUG, 1);
	...
	uint32_t *hashes_done)
{
	...
	{ 
		...
		lyra2v3_cpu_init(thr_id, d_hash2);
	...
	do {
		...
		lyra2v3_cpu_hash_32(thr_id, throughput, pdata[19], d_hash);
